//========================================================================
// Drag and drop image handling 文件拖拽
//========================================================================
...
//========================================================================
// Web page elements for functions to use获取网页元素
//========================================================================
...
function displayValue(data) {
 ...
 　  　strr += label[i]+" probability： "+value[i]+"<br/>"; //分割后的字符输出
       // strr =label[i]
          // +" probability： "+data.probability[i]+"<br/>"; //分割后的字符输出
}
  hide(loader);
